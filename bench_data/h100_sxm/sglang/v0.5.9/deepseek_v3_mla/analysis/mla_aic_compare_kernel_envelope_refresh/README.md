...
- 实机 layer 样本数: `104`
- case 数: `26`
- 跳过记录数: `26`，其中包含按规则忽略的首层。
- `context_mla_module` primary miss 验证: `通过`。

## 平均绝对百分比误差（相对实机 kernel 包络时间）

- DeepSeek fallback stack: `17.29%`
- WideEP module stack: `13.38%`
- Rule(prefix=0 -> WideEP, prefix>0 -> DeepSeek): `14.89%`
- Best-of-two by absolute error: `8.77%`
