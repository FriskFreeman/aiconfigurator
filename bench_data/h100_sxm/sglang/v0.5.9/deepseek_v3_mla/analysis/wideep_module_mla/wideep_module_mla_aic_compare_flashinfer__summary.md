...
- 本次 AIC 查询使用 `attention_backend=flashinfer`、`fmha_quant_mode=fp8_block`、`kvcache_quant_mode=fp8`。
...
- `整块 module 端到端到尾 kernel` MAPE: `58.37%`
- `整块 module GPU makespan` MAPE: `17.44%`
- `整块 module GPU kernel 加总` MAPE: `43.44%`
- `WideEP 对齐子模块 GPU makespan` MAPE: `19.30%`
- `WideEP 对齐子模块 GPU kernel 加总` MAPE: `52.64%`
- `WideEP 对齐子模块 host duration 加总` MAPE: `624.15%`

## Decode

- `整块 module 端到端到尾 kernel` MAPE: `97.57%`
- `整块 module GPU makespan` MAPE: `43.20%`
- `整块 module GPU kernel 加总` MAPE: `2.74%`
- `WideEP 对齐子模块 GPU makespan` MAPE: `36.36%`
- `WideEP 对齐子模块 GPU kernel 加总` MAPE: `17.02%`
- `WideEP 对齐子模块 host duration 加总` MAPE: `87.40%`
