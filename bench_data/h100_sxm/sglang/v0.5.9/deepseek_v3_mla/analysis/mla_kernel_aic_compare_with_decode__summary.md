...
- `MLA / bfloat16` 对 `real_attention_kernel_time_ms` 的平均绝对百分比误差: `12.03%`
- `MLA / fp8` 对 `real_attention_kernel_time_ms` 的平均绝对百分比误差: `51.52%`
- `Attention / bfloat16` 对 `real_attention_kernel_time_ms` 的平均绝对百分比误差: `38.04%`
- `Attention / fp8` 对 `real_attention_kernel_time_ms` 的平均绝对百分比误差: `35.60%`
