...
class EventHandler:
    ...
    def setup_static_events(components):
        components["estimate_btn"].click(
            ...
            inputs=[
                ...
                components["model_system_components"]["analytical_communication_mode"],
    ...
    def setup_disagg_pareto_events(components):
        components["estimate_btn"].click(
            ...
            inputs=[
                ...
                components["prefill_model_system_components"]["analytical_communication_mode"],
                ...
                components["decode_model_system_components"]["analytical_communication_mode"],
    ...
    # common events
    @staticmethod
    def setup_system_events(model_path_components, model_system_components):
