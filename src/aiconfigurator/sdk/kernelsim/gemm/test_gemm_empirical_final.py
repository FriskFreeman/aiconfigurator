...
import gemm_empirical_final as model
    ...
    def test_default_standard_preserves_v1_outputs(self) -> None:
        ...
        self.assertEqual(
            model.estimate_bf16_gemm(
                4096, 4096, 4096, 989e12, 3.35e12
            ).latency_us,
            195.43278540768858,
        )
        self.assertEqual(
            model.estimate_deepgemm_fp8(
                4096, 4096, 4096, 1.979e15, 3.35e12, "hopper"
            ).latency_us,
            141.31664252283954,
        )
        self.assertEqual(
            model.estimate_deepgemm_fp8(
                4096, 4096, 4096, 4.5e15, 8e12, "blackwell"
            ).latency_us,
            93.91004300283592,
        )
        self.assertEqual(
            model.estimate_sglang_fp8(
                4096, 4096, 4096, 1.979e15, 3.35e12
            ).latency_us,
            156.93580043573968,
        )
