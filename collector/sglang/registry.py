...
REGISTRY: list[OpEntry] = [
    ...
    OpEntry(
        op="wan_patch_embed",
        module="collector.sglang.collect_wan_patch_embed",
        get_func="get_wan_patch_embed_test_cases",
        run_func="run_wan_patch_embed",
        perf_filename=PerfFile.WAN_PATCH_EMBED,
    ),
    OpEntry(
        op="wan_rope",
        module="collector.sglang.collect_wan_rope",
        get_func="get_wan_rope_test_cases",
        run_func="run_wan_rope",
        perf_filename=PerfFile.WAN_ROPE,
    ),
    OpEntry(
        op="wan_attention",
        module="collector.sglang.collect_wan_attention",
        get_func="get_wan_attention_test_cases",
        run_func="run_wan_attention",
        perf_filename=PerfFile.WAN_ATTENTION,
    ),
    OpEntry(
        op="wan_sparse_attention",
        module="collector.sglang.collect_wan_sparse_attention",
        get_func="get_wan_sparse_attention_test_cases",
        run_func="run_wan_sparse_attention",
        perf_filename=PerfFile.WAN_SPARSE_ATTENTION,
    ),
    OpEntry(
        op="wan_elementwise",
        module="collector.sglang.collect_wan_elementwise",
        get_func="get_wan_elementwise_test_cases",
        run_func="run_wan_elementwise",
        perf_filename=PerfFile.WAN_ELEMENTWISE,
    ),
    OpEntry(
        op="wan_t5",
        module="collector.sglang.collect_wan_t5",
        get_func="get_wan_t5_test_cases",
        run_func="run_wan_t5",
        perf_filename=PerfFile.WAN_T5,
    ),
    OpEntry(
        op="wan_clip",
        module="collector.sglang.collect_wan_clip",
        get_func="get_wan_clip_test_cases",
        run_func="run_wan_clip",
        perf_filename=PerfFile.WAN_CLIP,
    ),
    OpEntry(
        op="wan_vae",
        module="collector.sglang.collect_wan_vae",
        get_func="get_wan_vae_test_cases",
        run_func="run_wan_vae",
        perf_filename=PerfFile.WAN_VAE,
    ),
    OpEntry(
        op="wan_vae_attention",
        module="collector.sglang.collect_wan_vae",
        get_func="get_wan_vae_attention_test_cases",
        run_func="run_wan_vae_attention",
        perf_filename=PerfFile.WAN_VAE_ATTENTION,
    ),
    OpEntry(
        op="wan_vae_elementwise",
        module="collector.sglang.collect_wan_vae",
        get_func="get_wan_vae_elementwise_test_cases",
        run_func="run_wan_vae_elementwise",
        perf_filename=PerfFile.WAN_VAE_ELEMENTWISE,
    ),
]
